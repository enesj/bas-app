...
return cljs.core.assoc.call(null,frame,new cljs.core.Keyword(null,"eids","eids",1546550700),eids,new cljs.core.Keyword(null,"specs","specs",1426570741),cljs.core.seq.call(null,new cljs.core.Keyword(null,"attrs","attrs",-2090668713).cljs$core$IFn$_invoke$arity$1(pattern)),new cljs.core.Keyword(null,"wildcard?","wildcard?",-686044101),new cljs.core.Keyword(null,"wildcard?","wildcard?",-686044101).cljs$core$IFn$_invoke$arity$1(pattern),new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.transient$.call(null,cljs.core.PersistentArrayMap.EMPTY),new cljs.core.Keyword(null,"results","results",-1134170113),(function (){var G__45500 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
if(cljs.core.seq.call(null,kvps)){
return cljs.core.conj_BANG_.call(null,G__45500,kvps);
} else {
return G__45500;
}
})());
...
var map__45502 = rec;
var map__45502__$1 = ((((!((map__45502 == null)))?(((((map__45502.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__45502.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__45502):map__45502);
var depth = cljs.core.get.call(null,map__45502__$1,new cljs.core.Keyword(null,"depth","depth",1768663640));
var seen = cljs.core.get.call(null,map__45502__$1,new cljs.core.Keyword(null,"seen","seen",-518999789));
...
var G__45504 = new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame);
var G__45504__$1 = (((G__45504 == null))?null:cljs.core.persistent_BANG_.call(null,G__45504));
if((G__45504__$1 == null)){
return null;
} else {
return cljs.core.get.call(null,G__45504__$1,key);
}
});
...
datascript.pull_api.pull_recursion_frame = (function datascript$pull_api$pull_recursion_frame(db,p__45505){
...
var frame = first__45508;
var frames = seq__45507__$1;
...
var or__3949__auto__ = datascript.pull_api.pull_seen_eid.call(null,frame__$1,frames,eid);
...
var results = (function (){var G__45509 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
if(cljs.core.seq.call(null,kvps)){
return cljs.core.conj_BANG_.call(null,G__45509,kvps);
} else {
return G__45509;
}
})();
...
var recursion = cljs.core.get.call(null,map__45510__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var pattern = cljs.core.get.call(null,map__45510__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
var pattern_45512 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
datascript.pull_api.expand_frame = ((function (pattern_45512){
...
return cljs.core.assoc.call(null,datascript.pull_api.subpattern_frame.call(null,pattern_45512,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});})(pattern_45512))
;
datascript.pull_api.pull_attr_datoms = (function datascript$pull_api$pull_attr_datoms(db,attr_key,attr,eid,forward_QMARK_,datoms,opts,p__45514){
var vec__45515 = p__45514;
var seq__45516 = cljs.core.seq.call(null,vec__45515);
var first__45517 = cljs.core.first.call(null,seq__45516);
var seq__45516__$1 = cljs.core.next.call(null,seq__45516);
var parent = first__45517;
var frames = seq__45516__$1;
var limit = cljs.core.get.call(null,opts,new cljs.core.Keyword(null,"limit","limit",-1355822363),(1000));
var attr_key__$1 = (function (){var or__3949__auto__ = new cljs.core.Keyword(null,"as","as",1148689641).cljs$core$IFn$_invoke$arity$1(opts);
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
return attr_key;
...
var found = cljs.core.not_empty.call(null,(function (){var G__45519 = datoms;
if(cljs.core.truth_(limit)){
return cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.take.call(null,limit),G__45519);
} else {
return G__45519;
}
})());
...
var datom_val = (cljs.core.truth_(forward_QMARK_)?((function (ref_QMARK_,component_QMARK_,multi_QMARK_,limit,attr_key__$1,found,vec__45515,seq__45516,first__45517,seq__45516__$1,parent,frames){
return (function (d){
return d.v;
});})(ref_QMARK_,component_QMARK_,multi_QMARK_,limit,attr_key__$1,found,vec__45515,seq__45516,first__45517,seq__45516__$1,parent,frames))
:((function (ref_QMARK_,component_QMARK_,multi_QMARK_,limit,attr_key__$1,found,vec__45515,seq__45516,first__45517,seq__45516__$1,parent,frames){
return (function (d){
return d.e;
});})(ref_QMARK_,component_QMARK_,multi_QMARK_,limit,attr_key__$1,found,vec__45515,seq__45516,first__45517,seq__45516__$1,parent,frames))
);
...
var as_value = (function (){var G__45525 = datom_val;
if(ref_QMARK_){
return cljs.core.comp.call(null,((function (G__45525,ref_QMARK_,component_QMARK_,multi_QMARK_,datom_val,limit,attr_key__$1,found,vec__45515,seq__45516,first__45517,seq__45516__$1,parent,frames){
return (function (p1__45513_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("db","id","db/id",-1388397098)],[p1__45513_SHARP_]);
});})(G__45525,ref_QMARK_,component_QMARK_,multi_QMARK_,datom_val,limit,attr_key__$1,found,vec__45515,seq__45516,first__45517,seq__45516__$1,parent,frames))
,G__45525);
} else {
return G__45525;
}
...
return cljs.core.conj.call(null,frames,cljs.core.update.call(null,parent,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,(function (){var G__45526 = cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.map.call(null,as_value),found);
if(single_QMARK_){
return cljs.core.first.call(null,G__45526);
} else {
return G__45526;
}
})()));
...
return cljs.core.conj.call(null,frames,(function (){var G__45527 = parent;
if(cljs.core.contains_QMARK_.call(null,opts,new cljs.core.Keyword(null,"default","default",-1987822328))){
return cljs.core.update.call(null,G__45527,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,new cljs.core.Keyword(null,"default","default",-1987822328).cljs$core$IFn$_invoke$arity$1(opts));
} else {
return G__45527;
}
})());
...
var vec__45532 = spec;
var attr_key = cljs.core.nth.call(null,vec__45532,(0),null);
var opts = cljs.core.nth.call(null,vec__45532,(1),null);
...
datascript.pull_api.filter_reverse_attrs = cljs.core.filter.call(null,(function (p__45539){
...
datascript.pull_api.pull_expand_reverse_frame = (function datascript$pull_api$pull_expand_reverse_frame(db,p__45543){
var vec__45544 = p__45543;
var seq__45545 = cljs.core.seq.call(null,vec__45544);
var first__45546 = cljs.core.first.call(null,seq__45545);
var seq__45545__$1 = cljs.core.next.call(null,seq__45545);
var frame = first__45546;
var frames = seq__45545__$1;
return datascript.pull_api.expand_result.call(null,frames,datascript.pull_api.into_BANG_.call(null,new cljs.core.Keyword(null,"expand-kvps","expand-kvps",44141154).cljs$core$IFn$_invoke$arity$1(frame),(function (){var or__3949__auto__ = datascript.pull_api.single_frame_result.call(null,new cljs.core.Keyword("datascript.pull-api","expand-rev","datascript.pull-api/expand-rev",2143627459),frame);
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
...
datascript.pull_api.pull_expand_frame = (function datascript$pull_api$pull_expand_frame(db,p__45547){
var vec__45548 = p__45547;
var seq__45549 = cljs.core.seq.call(null,vec__45548);
var first__45550 = cljs.core.first.call(null,seq__45549);
var seq__45549__$1 = cljs.core.next.call(null,seq__45549);
var frame = first__45550;
var frames = seq__45549__$1;
...
var vec__45551 = cljs.core.first.call(null,datoms_by_attr);
var attr = cljs.core.nth.call(null,vec__45551,(0),null);
var datoms = cljs.core.nth.call(null,vec__45551,(1),null);
...
var attr = cljs.core.get.call(null,map__45554__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var recursion = cljs.core.get.call(null,map__45554__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var rec = (function (){var G__45556 = recursion;
if(!((attr == null))){
return datascript.pull_api.push_recursion.call(null,G__45556,attr,eid);
} else {
return G__45556;
}
})();
...
var map__45557 = frame;
var map__45557__$1 = ((((!((map__45557 == null)))?(((((map__45557.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__45557.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__45557):map__45557);
var eid = cljs.core.get.call(null,map__45557__$1,new cljs.core.Keyword(null,"eid","eid",559519930));
var pattern = cljs.core.get.call(null,map__45557__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
var or__3949__auto__ = datascript.pull_api.pull_seen_eid.call(null,frame,frames,eid);
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
...
datascript.pull_api.pull_pattern_frame = (function datascript$pull_api$pull_pattern_frame(db,p__45559){
while(true){
var vec__45560 = p__45559;
var seq__45561 = cljs.core.seq.call(null,vec__45560);
var first__45562 = cljs.core.first.call(null,seq__45561);
var seq__45561__$1 = cljs.core.next.call(null,seq__45561);
var frame = first__45562;
var frames = seq__45561__$1;
var temp__5718__auto__ = cljs.core.seq.call(null,new cljs.core.Keyword(null,"eids","eids",1546550700).cljs$core$IFn$_invoke$arity$1(frame));
if(temp__5718__auto__){
var eids = temp__5718__auto__;
...
var G__45567 = db;
var G__45568 = cljs.core.conj.call(null,frames,datascript.pull_api.reset_frame.call(null,frame,cljs.core.rest.call(null,eids),cljs.core.not_empty.call(null,cljs.core.persistent_BANG_.call(null,new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__45567;
p__45559 = G__45568;
continue;
}
...
while(true){
var G__45569 = new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first.call(null,frames));
var G__45569__$1 = (((G__45569 instanceof cljs.core.Keyword))?G__45569.fqn:null);
switch (G__45569__$1) {
case "expand":
var G__45576 = db;
var G__45577 = datascript.pull_api.pull_expand_frame.call(null,db,frames);
db = G__45576;
frames = G__45577;
continue;
...
case "expand-rev":
var G__45578 = db;
var G__45579 = datascript.pull_api.pull_expand_reverse_frame.call(null,db,frames);
db = G__45578;
frames = G__45579;
continue;
...
case "pattern":
var G__45580 = db;
var G__45581 = datascript.pull_api.pull_pattern_frame.call(null,db,frames);
db = G__45580;
frames = G__45581;
continue;
...
case "recursion":
var G__45582 = db;
var G__45583 = datascript.pull_api.pull_recursion_frame.call(null,db,frames);
db = G__45582;
frames = G__45583;
continue;
...
var f = first__45572;
var remaining = seq__45571__$1;
var result = (function (){var G__45573 = cljs.core.persistent_BANG_.call(null,new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
if(cljs.core.not.call(null,new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f))){
return cljs.core.first.call(null,G__45573);
} else {
return G__45573;
}
})();
...
var G__45586 = db;
var G__45587 = cljs.core.conj.call(null,cljs.core.rest.call(null,remaining),(function (){var G__45574 = cljs.core.first.call(null,remaining);
if(cljs.core.truth_(result)){
return cljs.core.update.call(null,G__45574,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(f),result);
} else {
return G__45574;
}
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__45569__$1)].join('')));
...
var eids__$1 = cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.map.call(null,(function (p1__45588_SHARP_){
return datascript.db.entid_strict.call(null,db,p1__45588_SHARP_);
})),eids);
...
//# sourceMappingURL=pull_api.js.map?rel=1563552873466
