...
return true;
})], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-start","on-start",-1839785985),keechma.toolbox.pipeline.core.make_pipeline.call(null,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"begin","begin",-319034319),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (value,app_db,_){
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"repr","repr",669525472),"(ds/transact! (d/insert-sectors d/sectors))",new cljs.core.Keyword(null,"val","val",128701612),basapp.datascript.transact_BANG_.call(null,basapp.domain.bas.insert_sectors.call(null,basapp.domain.bas.sectors))], null);
}),(function (value,app_db,_){
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"repr","repr",669525472),"(ds/transact! (d/insert-departments d/departments))",new cljs.core.Keyword(null,"val","val",128701612),basapp.datascript.transact_BANG_.call(null,basapp.domain.bas.insert_departments.call(null,basapp.domain.bas.departments))], null);
}),(function (value,app_db,_){
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"repr","repr",669525472),"(ds/transact! (d/insert-employees d/employees))",new cljs.core.Keyword(null,"val","val",128701612),basapp.datascript.transact_BANG_.call(null,basapp.domain.bas.insert_employees.call(null,basapp.domain.bas.employees))], null);
}),(function (value,app_db,_){
...
//# sourceMappingURL=datascript.js.map?rel=1563554770325
