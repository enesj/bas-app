...
basapp.forms.sector.Form.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4205__auto__,k61458,else__4206__auto__){
var self__ = this;
var this__4205__auto____$1 = this;
var G__61462 = k61458;
var G__61462__$1 = (((G__61462 instanceof cljs.core.Keyword))?G__61462.fqn:null);
switch (G__61462__$1) {
case "validator":
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k61458,else__4206__auto__);
...
basapp.forms.sector.Form.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__61457){
var self__ = this;
var G__61457__$1 = this;
return (new cljs.core.RecordIter((0),G__61457__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"validator","validator",-1966190681)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
});
...
basapp.forms.sector.Form.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this61459,other61460){
var self__ = this;
var this61459__$1 = this;
return ((!((other61460 == null))) && ((this61459__$1.constructor === other61460.constructor)) && (cljs.core._EQ_.call(null,this61459__$1.validator,other61460.validator)) && (cljs.core._EQ_.call(null,this61459__$1.__extmap,other61460.__extmap)));
});
...
basapp.forms.sector.Form.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4210__auto__,k__4211__auto__,G__61457){
var self__ = this;
var this__4210__auto____$1 = this;
var pred__61463 = cljs.core.keyword_identical_QMARK_;
var expr__61464 = k__4211__auto__;
if(cljs.core.truth_(pred__61463.call(null,new cljs.core.Keyword(null,"validator","validator",-1966190681),expr__61464))){
return (new basapp.forms.sector.Form(G__61457,self__.__meta,self__.__extmap,null));
} else {
return (new basapp.forms.sector.Form(self__.validator,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__4211__auto__,G__61457),null));
}
});
...
basapp.forms.sector.Form.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4202__auto__,G__61457){
var self__ = this;
var this__4202__auto____$1 = this;
return (new basapp.forms.sector.Form(self__.validator,G__61457,self__.__extmap,self__.__hash));
});
 ...
 */
basapp.forms.sector.map__GT_Form = (function basapp$forms$sector$map__GT_Form(G__61461){
var extmap__4236__auto__ = (function (){var G__61467 = cljs.core.dissoc.call(null,G__61461,new cljs.core.Keyword(null,"validator","validator",-1966190681));
if(cljs.core.record_QMARK_.call(null,G__61461)){
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,G__61467);
} else {
return G__61467;
}
})();
return (new basapp.forms.sector.Form(new cljs.core.Keyword(null,"validator","validator",-1966190681).cljs$core$IFn$_invoke$arity$1(G__61461),null,cljs.core.not_empty.call(null,extmap__4236__auto__),null));
});

cljs.core._add_method.call(null,keechma.toolbox.forms.core.call,basapp.forms.sector.Form,(function (form,app_db,form_props,p__61469){
...
var cmd = first__61472;
var args = seq__61471__$1;
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"reset-form","reset-form",620246626),cmd)){
return keechma.toolbox.pipeline.core.make_pipeline.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"begin","begin",-319034319),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (vec__61470,seq__61471,first__61472,seq__61471__$1,cmd,args){
...
});})(vec__61470,seq__61471,first__61472,seq__61471__$1,cmd,args))
], null)], null));
} else {
return null;
}
...
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"repr","repr",669525472),"(t/block-until!\r\n [form-props :get-data]\r\n (fn* [p1__61474#] (get-in p1__61474# [:kv :datascript-initialized?])))",new cljs.core.Keyword(null,"val","val",128701612),keechma.toolbox.tasks.block_until_BANG_.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [form_props,new cljs.core.Keyword(null,"get-data","get-data",454586681)], null),(function (p1__61474_SHARP_){
return cljs.core.get_in.call(null,p1__61474_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"kv","kv",-1099920440),new cljs.core.Keyword(null,"datascript-initialized?","datascript-initialized?",2024340329)], null));
}))], null);
...
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"repr","repr",669525472),"(ds/transact!\r\n (insert-sector (:name data) (:short-name data) (:active data) nil))",new cljs.core.Keyword(null,"val","val",128701612),basapp.datascript.transact_BANG_.call(null,basapp.domain.seed.insert_sector.call(null,new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(data),new cljs.core.Keyword(null,"short-name","short-name",-1767085022).cljs$core$IFn$_invoke$arity$1(data),new cljs.core.Keyword(null,"active","active",1895962068).cljs$core$IFn$_invoke$arity$1(data),null))], null);
})], null)], null));
}));
...
//# sourceMappingURL=sector.js.map?rel=1568191592340
