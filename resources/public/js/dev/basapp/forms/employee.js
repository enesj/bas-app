...
basapp.forms.employee.Form.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4205__auto__,k61406,else__4206__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k61406,else__4206__auto__);
...
basapp.forms.employee.Form.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__61405){
var self__ = this;
var G__61405__$1 = this;
return (new cljs.core.RecordIter((0),G__61405__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"validator","validator",-1966190681)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
});
...
basapp.forms.employee.Form.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this61407,other61408){
var self__ = this;
var this61407__$1 = this;
return ((!((other61408 == null))) && ((this61407__$1.constructor === other61408.constructor)) && (cljs.core._EQ_.call(null,this61407__$1.validator,other61408.validator)) && (cljs.core._EQ_.call(null,this61407__$1.__extmap,other61408.__extmap)));
});
...
basapp.forms.employee.Form.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4210__auto__,k__4211__auto__,G__61405){
var self__ = this;
var this__4210__auto____$1 = this;
var pred__61411 = cljs.core.keyword_identical_QMARK_;
var expr__61412 = k__4211__auto__;
if(cljs.core.truth_(pred__61411.call(null,new cljs.core.Keyword(null,"validator","validator",-1966190681),expr__61412))){
return (new basapp.forms.employee.Form(G__61405,self__.__meta,self__.__extmap,null));
} else {
return (new basapp.forms.employee.Form(self__.validator,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__4211__auto__,G__61405),null));
}
});
...
basapp.forms.employee.Form.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4202__auto__,G__61405){
var self__ = this;
var this__4202__auto____$1 = this;
return (new basapp.forms.employee.Form(self__.validator,G__61405,self__.__extmap,self__.__hash));
});
 ...
 */
basapp.forms.employee.map__GT_Form = (function basapp$forms$employee$map__GT_Form(G__61409){
var extmap__4236__auto__ = (function (){var G__61414 = cljs.core.dissoc.call(null,G__61409,new cljs.core.Keyword(null,"validator","validator",-1966190681));
if(cljs.core.record_QMARK_.call(null,G__61409)){
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,G__61414);
} else {
return G__61414;
}
})();
return (new basapp.forms.employee.Form(new cljs.core.Keyword(null,"validator","validator",-1966190681).cljs$core$IFn$_invoke$arity$1(G__61409),null,cljs.core.not_empty.call(null,extmap__4236__auto__),null));
});
...
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"repr","repr",669525472),"(t/block-until!\r\n [form-props :get-data]\r\n (fn* [p1__61416#] (get-in p1__61416# [:kv :datascript-initialized?])))",new cljs.core.Keyword(null,"val","val",128701612),keechma.toolbox.tasks.block_until_BANG_.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [form_props,new cljs.core.Keyword(null,"get-data","get-data",454586681)], null),(function (p1__61416_SHARP_){
return cljs.core.get_in.call(null,p1__61416_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"kv","kv",-1099920440),new cljs.core.Keyword(null,"datascript-initialized?","datascript-initialized?",2024340329)], null));
}))], null);
...
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"repr","repr",669525472),"(ds/transact!\r\n (insert-employee\r\n  (:name data)\r\n  (:last-name data)\r\n  (:uname data)\r\n  (:email data)\r\n  (:phone data)\r\n  (:type data)\r\n  (:position data)\r\n  (:department data)\r\n  (:office data)\r\n  (:active data)\r\n  nil))",new cljs.core.Keyword(null,"val","val",128701612),basapp.datascript.transact_BANG_.call(null,basapp.domain.seed.insert_employee.call(null,new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(data),new cljs.core.Keyword(null,"last-name","last-name",-1695738974).cljs$core$IFn$_invoke$arity$1(data),new cljs.core.Keyword(null,"uname","uname",1929669230).cljs$core$IFn$_invoke$arity$1(data),new cljs.core.Keyword(null,"email","email",1415816706).cljs$core$IFn$_invoke$arity$1(data),new cljs.core.Keyword(null,"phone","phone",-763596057).cljs$core$IFn$_invoke$arity$1(data),new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(data),new cljs.core.Keyword(null,"position","position",-2011731912).cljs$core$IFn$_invoke$arity$1(data),new cljs.core.Keyword(null,"department","department",-359157087).cljs$core$IFn$_invoke$arity$1(data),new cljs.core.Keyword(null,"office","office",-733494767).cljs$core$IFn$_invoke$arity$1(data),new cljs.core.Keyword(null,"active","active",1895962068).cljs$core$IFn$_invoke$arity$1(data),null))], null);
})], null)], null));
}));
...
//# sourceMappingURL=employee.js.map?rel=1568191592111
