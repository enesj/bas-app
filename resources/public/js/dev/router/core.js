...
return clojure.string.replace.call(null,clojure.string.trim.call(null,(function (){var or__3949__auto__ = route;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__40271__$1)].join('')));
...
router.core.process_route = (function router$core$process_route(p__40275){
var vec__40276 = p__40275;
var route = cljs.core.nth.call(null,vec__40276,(0),null);
var defaults = cljs.core.nth.call(null,vec__40276,(1),null);
...
return cljs.core.apply.call(null,cljs.core.dissoc,matches,(function (){var iter__4324__auto__ = (function router$core$remove_empty_matches_$_iter__40282(s__40283){
return (new cljs.core.LazySeq(null,(function (){
var s__40283__$1 = s__40283;
while(true){
var temp__5720__auto__ = cljs.core.seq.call(null,s__40283__$1);
if(temp__5720__auto__){
var s__40283__$2 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__40283__$2)){
var c__4322__auto__ = cljs.core.chunk_first.call(null,s__40283__$2);
var size__4323__auto__ = cljs.core.count.call(null,c__4322__auto__);
var b__40285 = cljs.core.chunk_buffer.call(null,size__4323__auto__);
if((function (){var i__40284 = (0);
while(true){
if((i__40284 < size__4323__auto__)){
var vec__40287 = cljs.core._nth.call(null,c__4322__auto__,i__40284);
var k = cljs.core.nth.call(null,vec__40287,(0),null);
var v = cljs.core.nth.call(null,vec__40287,(1),null);
if(((cljs.core._EQ_.call(null,v,"null")) || (cljs.core.empty_QMARK_.call(null,v)))){
cljs.core.chunk_append.call(null,b__40285,k);

var G__40302 = (i__40284 + (1));
i__40284 = G__40302;
continue;
} else {
var G__40303 = (i__40284 + (1));
i__40284 = G__40303;
continue;
}
} else {
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__40285),router$core$remove_empty_matches_$_iter__40282.call(null,cljs.core.chunk_rest.call(null,s__40283__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__40285),null);
}
} else {
var vec__40298 = cljs.core.first.call(null,s__40283__$2);
var k = cljs.core.nth.call(null,vec__40298,(0),null);
var v = cljs.core.nth.call(null,vec__40298,(1),null);
if(((cljs.core._EQ_.call(null,v,"null")) || (cljs.core.empty_QMARK_.call(null,v)))){
return cljs.core.cons.call(null,k,router$core$remove_empty_matches_$_iter__40282.call(null,cljs.core.rest.call(null,s__40283__$2)));
} else {
var G__40307 = cljs.core.rest.call(null,s__40283__$2);
s__40283__$1 = G__40307;
continue;
}
}
} else {
...
return iter__4324__auto__.call(null,matches);
})());
});
router.core.expand_route = (function router$core$expand_route(route){
var strip_slashes = (function (p__40308){
var vec__40309 = p__40308;
var route__$1 = cljs.core.nth.call(null,vec__40309,(0),null);
var defaults = cljs.core.nth.call(null,vec__40309,(1),null);
...
var default_val = ((clojure.string.starts_with_QMARK_.call(null,url,placeholder))?"":"");
...
var vec__40336 = clojure.string.split.call(null,url,/\?/);
var u = cljs.core.nth.call(null,vec__40336,(0),null);
var q = cljs.core.nth.call(null,vec__40336,(1),null);
...
var query = router.core.remove_empty_matches.call(null,clojure.walk.keywordize_keys.call(null,secretary.core.decode_query_params.call(null,(function (){var or__3949__auto__ = q;
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
return "";
...
//# sourceMappingURL=core.js.map?rel=1563552867210
