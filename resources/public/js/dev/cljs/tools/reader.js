...
var G__46278 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__46278;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__46279 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__46279,ch);
...
if(("\\" === ch__$1)){
var ch_46287__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_46287__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_46287__$2);
} else {
}

var G__46288 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__46288;
continue;
}
}
...
var vec__46325 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__46325,(0),null);
var start_column = cljs.core.nth.call(null,vec__46325,(1),null);
...
var G__46329 = cljs.core.conj_BANG_.call(null,a,form);
a = G__46329;
continue;
}
}
...
var _STAR_read_delim_STAR_46330 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_46330;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__46331 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__46331,(0),null);
var start_column = cljs.core.nth.call(null,vec__46331,(1),null);
...
var vec__46334 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__46334,(0),null);
var end_column = cljs.core.nth.call(null,vec__46334,(1),null);
...
var vec__46344 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__46344,(0),null);
var start_column = cljs.core.nth.call(null,vec__46344,(1),null);
...
var vec__46347 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__46347,(0),null);
var end_column = cljs.core.nth.call(null,vec__46347,(1),null);
...
var vec__46357 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__46357,(0),null);
var start_column = cljs.core.nth.call(null,vec__46357,(1),null);
...
var vec__46360 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__46360,(0),null);
var end_column = cljs.core.nth.call(null,vec__46360,(1),null);
...
var sb = (function (){var G__46373 = (new goog.string.StringBuffer());
G__46373.append(initch);
...
var G__46375 = (function (){var G__46374 = sb;
G__46374.append(ch);

return G__46374;
})();
var G__46376 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__46375;
ch = G__46376;
continue;
}
...
switch (G__46383) {
case "\\":
var G__46397 = (function (){var G__46384 = sb;
G__46384.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__46384;
})();
var G__46398 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__46397;
ch = G__46398;
continue;
...
break;
default:
var G__46399 = (function (){var G__46385 = sb;
G__46385.append(ch);

return G__46385;
})();
var G__46400 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__46399;
ch = G__46400;
continue;
...
var vec__46402 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__46402,(0),null);
var end_column = cljs.core.nth.call(null,vec__46402,(1),null);
...
var vec__46405 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__46405,(0),null);
var column = cljs.core.nth.call(null,vec__46405,(1),null);
...
var vec__46426 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__46426,(0),null);
var column = cljs.core.nth.call(null,vec__46426,(1),null);
...
var vec__46433 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__46433,(0),null);
var column = cljs.core.nth.call(null,vec__46433,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__46447 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__46447,(0),null);
var start_column = cljs.core.nth.call(null,vec__46447,(1),null);
...
var vec__46450 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__46450,(0),null);
var end_column = cljs.core.nth.call(null,vec__46450,(1),null);
...
var G__46519 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__46519,true,null,opts,pending_forms);
...
var G__46551 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__46551)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__46551)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__46551)){
...
var _STAR_suppress_read_STAR_46710 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_46710;
}});
...
var G__46724 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__46724,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__46724,rdr,first_line);
...
var G__46754 = matched;
var G__46755 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__46754;
finished = G__46755;
continue;
} else {
...
var _STAR_suppress_read_STAR_46766 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_46766;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env46787 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__46789 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__46789,"(");
...
var G__46797 = (i + (1));
var G__46798 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3949__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env46787;
}});
/**
...
var ch = temp__5718__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__46816 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__46816);
...
var G__46845 = cljs.core.next.call(null,s__$1);
var G__46846 = ret;
s__$1 = G__46845;
r = G__46846;
continue;
...
var G__46854 = cljs.core.next.call(null,s);
var G__46855 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__46854;
key_vals = G__46855;
continue;
} else {
...
var gensym_env46901 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env46901;
}});
...
var temp__5718__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__46902 = token;
var G__46902__$1 = (((G__46902 == null))?null:cljs.core.subs.call(null,G__46902,(1)));
var G__46902__$2 = (((G__46902__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__46902__$1));
var G__46902__$3 = (((G__46902__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__46902__$2));
var G__46902__$4 = (((G__46902__$3 == null))?null:cljs.core.symbol.call(null,G__46902__$3));
if((G__46902__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__46902__$4);
}
})():(function (){var G__46903 = token;
var G__46903__$1 = (((G__46903 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__46903));
if((G__46903__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__46903__$1);
}
})()
));
if(cljs.core.truth_(temp__5718__auto__)){
...
var temp__5718__auto__ = (function (){var or__3949__auto__ = cljs.tools.reader._STAR_data_readers_STAR_.call(null,tag);
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__46924,reader){
...
var eof = cljs.core.get.call(null,map__46925__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4531__auto___46980 = arguments.length;
var i__4532__auto___46982 = (0);
while(true){
if((i__4532__auto___46982 < len__4531__auto___46980)){
args__4534__auto__.push((arguments[i__4532__auto___46982]));

var G__46984 = (i__4532__auto___46982 + (1));
i__4532__auto___46982 = G__46984;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq46957){
var G__46958 = cljs.core.first.call(null,seq46957);
var seq46957__$1 = cljs.core.next.call(null,seq46957);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__46958,seq46957__$1);
});


//# sourceMappingURL=reader.js.map?rel=1563552874963
