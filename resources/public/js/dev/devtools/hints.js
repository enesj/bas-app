...
var map__73149 = top_item;
var map__73149__$1 = ((((!((map__73149 == null)))?(((((map__73149.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__73149.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__73149):map__73149);
var file = cljs.core.get.call(null,map__73149__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__73149__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__73149__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e73148){var _e = e73148;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5718__auto___73151 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5718__auto___73151)){
var seen_errors_73152 = temp__5718__auto___73151;
if(cljs.core.truth_(seen_errors_73152.has(self))){
} else {
seen_errors_73152.add(self);

var temp__5720__auto___73153 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5720__auto___73153)){
var sense_73154 = temp__5720__auto___73153;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_73154)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1563552901387
