...
var o71906 = temp__5718__auto__;
var temp__5718__auto____$1 = (o71906["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o71907 = temp__5718__auto____$1;
return (o71907["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__71268__auto__ = f;
return (o__71268__auto__["toString"]).call(o__71268__auto__);
} else {
return "";
}
}catch (e71908){var _ = e71908;
return "";
}});
...
try{var o__71268__auto___71910 = t;
(o__71268__auto___71910["cljs$lang$ctorPrWriter"]).call(o__71268__auto___71910,t,writer);
}catch (e71909){var __71911 = e71909;
}
...
var char_code = (function (){var o__71268__auto__ = (new String(char$));
return (o__71268__auto__["charCodeAt"]).call(o__71268__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__71268__auto__ = String;
return (o__71268__auto__["fromCharCode"]).call(o__71268__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__71912 = num_code;
switch (G__71912) {
case (1):
return (185);
...
var o__71268__auto__ = String;
return (o__71268__auto__["fromCharCode"]).call(o__71268__auto__,superscript_code);
});
/**
...
}catch (e71914){var _e__71275__auto__ = e71914;
return false;
}})())){
...
var vec__71915 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__71915,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o71918 = temp__5718__auto__;
var temp__5718__auto____$1 = (o71918["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o71919 = temp__5718__auto____$1;
return (o71919["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4531__auto___71926 = arguments.length;
var i__4532__auto___71927 = (0);
while(true){
if((i__4532__auto___71927 < len__4531__auto___71926)){
args__4534__auto__.push((arguments[i__4532__auto___71927]));

var G__71928 = (i__4532__auto___71927 + (1));
i__4532__auto___71927 = G__71928;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__71922){
var vec__71923 = p__71922;
var ns_detector = cljs.core.nth.call(null,vec__71923,(0),null);
...
var G__71929 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__71930 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__71929;
remaining_tokens = G__71930;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq71920){
var G__71921 = cljs.core.first.call(null,seq71920);
var seq71920__$1 = cljs.core.next.call(null,seq71920);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__71921,seq71920__$1);
});
...
var vec__71934 = cljs.core.split_with.call(null,(function (p1__71933_SHARP_){
return cljs.core.not_EQ_.call(null,p1__71933_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__71934,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__71934,(1),null);
...
var vec__71937 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__71937,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__71937,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__71940 = cljs.core.rest.call(null,remaining_tokens);
var G__71941 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__71940;
name_tokens = G__71941;
continue;
} else {
...
var vec__71944 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__71944,(0),null);
var arity = cljs.core.nth.call(null,vec__71944,(1),null);
var vec__71947 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__71947,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__71947,(1),null);
var vec__71950 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__71950,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__71950,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__71950,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__71950,(3),null);
...
var vec__71956 = result;
var munged_ns = cljs.core.nth.call(null,vec__71956,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__71956,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__71956,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__71956,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__71956,(4),null);
var arity = cljs.core.nth.call(null,vec__71956,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__71960 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__71960,(0),null);
var args = cljs.core.nth.call(null,vec__71960,(1),null);
var vec__71963 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__71963,(0),null);
var name = cljs.core.nth.call(null,vec__71963,(1),null);
...
var G__71966 = (arity + (1));
var G__71967 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__71968){
var vec__71969 = p__71968;
var arity = cljs.core.nth.call(null,vec__71969,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__71969,(1),null);
...
return (function (p1__71972_SHARP_){
return cljs.core.get.call(null,arities,p1__71972_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return (function (p1__71973_SHARP_){
return cljs.core.drop.call(null,(2),p1__71973_SHARP_);
...
var args__4534__auto__ = [];
var len__4531__auto___71980 = arguments.length;
var i__4532__auto___71981 = (0);
while(true){
if((i__4532__auto___71981 < len__4531__auto___71980)){
args__4534__auto__.push((arguments[i__4532__auto___71981]));

var G__71982 = (i__4532__auto___71981 + (1));
i__4532__auto___71981 = G__71982;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__71976){
var vec__71977 = p__71976;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__71977,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq71974){
var G__71975 = cljs.core.first.call(null,seq71974);
var seq71974__$1 = cljs.core.next.call(null,seq71974);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__71975,seq71974__$1);
});
...
var map__71985 = options;
var map__71985__$1 = ((((!((map__71985 == null)))?(((((map__71985.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__71985.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__71985):map__71985);
var include_ns_QMARK_ = cljs.core.get.call(null,map__71985__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__71985__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__71985__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__71985__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__71986 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__71986,(0),null);
var fn_name = cljs.core.nth.call(null,vec__71986,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__71986,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__71986,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__71986,(4),null);
var arity = cljs.core.nth.call(null,vec__71986,(5),null);
...
var o__71268__auto__ = f;
return (o__71268__auto__["getBasis"]).call(o__71268__auto__);
});
/**
...
}catch (e71990){var _e__71275__auto__ = e71990;
...
var G__71991 = (obj[cljs.core.first.call(null,path)]);
var G__71992 = cljs.core.rest.call(null,path);
obj = G__71991;
path = G__71992;
continue;
} else {
...
return (function (accum,p__71993){
var vec__71994 = p__71993;
var bit = cljs.core.nth.call(null,vec__71994,(0),null);
var protocol = cljs.core.nth.call(null,vec__71994,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__71997){
var vec__71998 = p__71997;
var ns = cljs.core.nth.call(null,vec__71998,(0),null);
var name = cljs.core.nth.call(null,vec__71998,(1),null);
var selector = cljs.core.nth.call(null,vec__71998,(2),null);
...
return (function (p__72002){
var vec__72003 = p__72002;
var munged_name = cljs.core.nth.call(null,vec__72003,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__72003,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__72003,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__72001_SHARP_){
return (obj[cljs.core.first.call(null,p1__72001_SHARP_)]);
});})(name,sorted_matches,vec__72003,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1563552897852
