...
var G__27734 = o;
(G__27734[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__27738 = o;
(G__27738[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__27785 = props;
var G__27785__$1 = ((((!((id == null))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__27785,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__27785);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__27785__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__27788){
...
var props = map__27789__$1;
var class$ = cljs.core.get.call(null,map__27789__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__27789,map__27789__$1,props,class$){
return (function (c){
...
});})(map__27789,map__27789__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__27799){
...
var on_write = cljs.core.get.call(null,map__27800__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__27800,map__27800__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__27800,map__27800__$1,on_write))
);
} else {
...
var G__27826 = jsprops;
(G__27826["defaultValue"] = value);

(G__27826["onChange"] = ((function (G__27826,v,value,on_change){
return (function (p1__27825_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__27825_SHARP_);
});})(G__27826,v,value,on_change))
);
...
var vec__27845 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__27845,(0),null);
var id = cljs.core.nth.call(null,vec__27845,(1),null);
var class$ = cljs.core.nth.call(null,vec__27845,(2),null);
...
var jsprops = ({"argv": v});
var temp__5724__auto___27861 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5724__auto___27861 == null)){
} else {
var key_27862 = temp__5724__auto___27861;
(jsprops["key"] = key_27862);
}
...
var temp__5724__auto___27867 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5724__auto___27867 == null)){
} else {
var key_27868 = temp__5724__auto___27867;
reagent.impl.template.oset.call(null,jsprops,"key",key_27868);
}
...
var G__27873 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__27873["name"] = c);
...
var i__4532__auto___27914 = (0);
while(true){
if((i__4532__auto___27914 < len__4531__auto___27910)){
args__4534__auto__.push((arguments[i__4532__auto___27914]));

var G__27915 = (i__4532__auto___27914 + (1));
i__4532__auto___27914 = G__27915;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq27904){
var G__27905 = cljs.core.first.call(null,seq27904);
var seq27904__$1 = cljs.core.next.call(null,seq27904);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27905,seq27904__$1);
});
...
break;
default:
var G__27918 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__27918;
continue;
...
var n__4408__auto___27920 = a.length;
var i_27921 = (0);
while(true){
if((i_27921 < n__4408__auto___27920)){
(a[i_27921] = reagent.impl.template.as_element.call(null,(a[i_27921])));

var G__27922 = (i_27921 + (1));
i_27921 = G__27922;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__4408__auto___27925 = a.length;
var i_27927 = (0);
while(true){
if((i_27927 < n__4408__auto___27925)){
var val_27928 = (a[i_27927]);
if(((cljs.core.vector_QMARK_.call(null,val_27928)) && ((reagent.impl.template.key_from_vec.call(null,val_27928) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_27927] = reagent.impl.template.as_element.call(null,val_27928));

var G__27929 = (i_27927 + (1));
i_27927 = G__27929;
continue;
} else {
}
...
var ctx = ({});
var vec__27934 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__27934,(0),null);
var derefed = cljs.core.nth.call(null,vec__27934,(1),null);
...
var G__27937 = (cljs.core.count.call(null,argv) - first_child);
switch (G__27937) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__27937){
...
//# sourceMappingURL=template.js.map?rel=1563552855241
