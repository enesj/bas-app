...
return (new CustomEvent(event_name,(function (){var obj73224 = {"detail":data};
return obj73224;
})()));
} else {
...
var f = (function (){var pred__73231 = cljs.core._EQ_;
var expr__73232 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__73231.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__73232))){
return ((function (pred__73231,expr__73232){
return (function (p1__73225_SHARP_){
return console.warn(p1__73225_SHARP_);
});
;})(pred__73231,expr__73232))
} else {
if(cljs.core.truth_(pred__73231.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__73232))){
return ((function (pred__73231,expr__73232){
return (function (p1__73226_SHARP_){
return console.debug(p1__73226_SHARP_);
});
;})(pred__73231,expr__73232))
} else {
if(cljs.core.truth_(pred__73231.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__73232))){
return ((function (pred__73231,expr__73232){
return (function (p1__73227_SHARP_){
return console.error(p1__73227_SHARP_);
});
;})(pred__73231,expr__73232))
} else {
return ((function (pred__73231,expr__73232){
return (function (p1__73228_SHARP_){
return console.log(p1__73228_SHARP_);
});
;})(pred__73231,expr__73232))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__73235){
var map__73236 = p__73235;
var map__73236__$1 = ((((!((map__73236 == null)))?(((((map__73236.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__73236.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__73236):map__73236);
var opts = map__73236__$1;
var eval_fn = cljs.core.get.call(null,map__73236__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return (function (p1__73238_SHARP_){
return new_def.callback(p1__73238_SHARP_);
});})(new_def))
);
...
return (function (p__73239){
var vec__73240 = p__73239;
var ky = cljs.core.nth.call(null,vec__73240,(0),null);
var v = cljs.core.nth.call(null,vec__73240,(1),null);
...
}catch (e73245){if((e73245 instanceof Error)){
var e = e73245;
return not_found;
} else {
throw e73245;
...
//# sourceMappingURL=utils.js.map?rel=1563552901659
