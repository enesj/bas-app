...
var G__28494 = cljs.core.first.call(null,element_str);
switch (G__28494) {
case "?":
arr.push((1));
...
var G__28496 = cljs.core.next.call(null,items);
items = G__28496;
continue;
} else {
return null;
...
var G__28497 = cljs.core.next.call(null,items);
items = G__28497;
continue;
} else {
return null;
...
var G__28502 = cljs.core.next.call(null,cljs.core.next.call(null,items));
items = G__28502;
continue;
} else {
return true;
...
switch (G__28505) {
case (0):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_.call(null,path,((function (G__28505){
return (function (p1__28503_SHARP_){
return cljs.core.not_EQ_.call(null,p1__28503_SHARP_,(2));
});})(G__28505))
))){
...
return cljs.core.not_EQ_.call(null,p1__28504_SHARP_,(1));
});})(G__28505))
))){
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__28505)].join('')));

}
}
});

//# sourceMappingURL=schema.js.map?rel=1563552856514
